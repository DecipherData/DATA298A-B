...
anvil.server.connect('server_H6D2EQOUYB7XZXXF67QTHLFO-4W4H6GUE6DYIWZXO') # to connect to server using anvil key

# Replace with your Google Maps API key
api_key = "AIzaSyArAhHIcfD4Tw4FnkdOPJ7O6HZPKC56HlI"

# Replace with your Llama 2 API key
llama_api_key = "LL-y6AxkHD7cDvhZxiosy4kzvJigvc6OGmMcM1nW2G8LMEuAqFgqNJj5DDgCpC1hyki"
