...
base_dir = r'C:\Users\sonal\OneDrive\Documents\train_val_test'
...
val_datagen = ImageDataGenerator(preprocessing_function=keras.applications.mobilenet_v2.preprocess_input)
